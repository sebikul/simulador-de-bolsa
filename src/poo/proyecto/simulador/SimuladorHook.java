...
/**
 * Clase abstracta para implementar una clase que recibira notificaciones en
 * ciertas instancias de un ciclo. No es interfaz pues no todo simulador tiene
 * que implementar todos los hooks.
 */

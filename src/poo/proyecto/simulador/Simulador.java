...
public abstract class Simulador extends Thread {
     ...
     * iteracion.
     *
     * @param hook Implementacion de SimuladorHook para ser llamada en momentos
     ...
     *
     * @param maxCiclos Cantidad de ciclos a simular.
     * @param hooks     Implementacion de SimuladorHook para ser llamada en momentos
     *                  especificos de la simulacion.
     */
     ...
     *
     * @throws IllegalStateException si no se generaron agentes, inversores, o no se seteo el
     *                               mercado.
     */
    ...
    public final ResultadosSimulacion resultados() throws Exception {
        ...
        ArrayList<Inversor> inversores = new ArrayList<Inversor>();

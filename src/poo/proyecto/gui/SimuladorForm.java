...
public class SimuladorForm {
	...
	private DefaultListModel<Titulo> modelTitulos = new DefaultListModel<Titulo>();
	private DefaultListModel<Inversor> modelInversores = new DefaultListModel<Inversor>();
	...
	private void $$$setupUI$$$() {
		...
		panel1.add(tabbedPane1, new GridConstraints(0, 0, 1, 1,
				...
				new Dimension(800, 800), null, 0, false));
		final JPanel panel2 = new JPanel();
		panel2.setLayout(new GridLayoutManager(3, 2, new Insets(0, 0, 0, 0),
				-1, -1));
		...
		panel2.add(labelEstado, new GridConstraints(0, 1, 1, 1,
				GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
				GridConstraints.SIZEPOLICY_FIXED,
				GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		final JPanel panel3 = new JPanel();
		panel3.setLayout(new GridLayoutManager(2, 3, new Insets(0, 0, 0, 0),
				-1, -1));
		panel2.add(panel3, new GridConstraints(2, 0, 1, 2,
				GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
				GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel3.add(iniciarBoton, new GridConstraints(0, 1, 1, 1,
				GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
				GridConstraints.SIZEPOLICY_CAN_SHRINK
						| GridConstraints.SIZEPOLICY_CAN_GROW,
				GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		final Spacer spacer1 = new Spacer();
		panel3.add(spacer1, new GridConstraints(0, 0, 1, 1,
				GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
		...
		panel3.add(detenerButton, new GridConstraints(0, 2, 1, 1,
				GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
				GridConstraints.SIZEPOLICY_CAN_SHRINK
						| GridConstraints.SIZEPOLICY_CAN_GROW,
				GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		final Spacer spacer2 = new Spacer();
		panel3.add(spacer2, new GridConstraints(1, 0, 1, 1,
		...
		panel2.add(labelCiclo, new GridConstraints(1, 1, 1, 1,
				GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
				GridConstraints.SIZEPOLICY_FIXED,
				GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		panelTitulos = new JPanel();
		panelTitulos.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0,
				0), -1, -1));
		...
		panelTitulos.add(splitPanelTitulos, new GridConstraints(0, 0, 1, 1,
				GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
				GridConstraints.SIZEPOLICY_CAN_SHRINK
						| GridConstraints.SIZEPOLICY_CAN_GROW,
				GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panelInversores.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0,
				0, 0), -1, -1));
		tabbedPane1.addTab("Inversores", panelInversores);
		splitPanelInversores = new JSplitPane();
		splitPanelInversores.setResizeWeight(0.2);
		panelInversores.add(splitPanelInversores, new GridConstraints(0, 0, 1,
		...
		listInversores = new JList<Inversor>();
